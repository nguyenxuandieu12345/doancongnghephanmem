<html>
	<head>
		<meta charset="utf-8">
		<title>Chi tiết khóa sách</title>
...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SUN RISE HOTEL,</p>
				<p>Đường Lê Duẩn,<br>TP.Vinh,<br>Nghệ An.</p>
				<p>0912894015</p>
			</address>
		...
		<article>
			...
			<table class="meta">
				...
				<tr>
					<th><span >Ngày nhận phòng</span></th>
			...
			<table >
					<tr> 
						<td>Điện thoại khách hàng : -  <?php echo $phone; ?> </td>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span ><?php echo $Bed_type; ?>  Giường </span></td>
						<td><span ><?php echo $nodays; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- levinh0409201@gmail.com || Phone :- 0912894015 </p>
			</div>
		</aside>
	</body>
</html>
