        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Bản tin</a>
                    </li>
					<li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Tin tức<small> Bảng điều khiển</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
			   ...
			   ?>
                ...
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3>Gửi tin tức đến người theo dõi</h3>
						<?php
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Soạn tin tức</h4>
                                        </div>
										<form method="post">
