                    ...
                    <div class="panel panel-default">
									...
									{	
										...
										if($co=="Not Conform")
										{
											echo"<tr>
												...
												<th><a href='roombook.php?rid=".$trow['id']." ' class='btn btn-primary'>Hoạt động</a></th>
												</tr>";
										}	
                      ...
                      <!-- End  Basic Table  --> 
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
											...
											<button class="btn btn-primary" type="button">
												 Đặt trước  <span class="badge"><?php echo $r ; ?></span>
											</button>
                            ...
                            <div class="table-responsive">
								...
								<a href="messages.php" class="btn btn-primary">Hành động mặc định</a>
                            </div>
                        </div>
                    </div>
                                        </div>
