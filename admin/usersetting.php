        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Trang tổng quan người dùng</a>
                    </li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Quản Trị<small> Tài khoản </small>
                        </h1>
                    </div>
                </div> 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Têm tên người dùng và mật khẩu</h4>
                                        </div>
										<form method="post">
