...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">nguyenxuandieu607@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>0946637308</li>	
					<li class="s-bar">
						<div class="search">
...
<!-- //header -->
		<!-- banner -->
	<div id="Trang chủ" class="w3ls-banner">
		<!-- banner-text -->
		<div class="slider">
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>SUN RISE</h4>
									<h3>Chúng tôi biết bạn thích gì</h3>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>SUN RISE</h4>
									<h3>Ở cùng bạn bè và gia đình</h3>
										<p>Đến và tận hưởng khoảnh khắc quáy giá cùng chúng tôi</p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Tìm hiểu thêm</a>
			</div>
								</div>	
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>SUN RISE</h4>
								<h3>Muốn có kỳ nghỉ sang trọng?</h3>
										<p>Đặt chỗ ngay hôm nay</p>
									<div class="agileits_w3layouts_more menu__item">
											<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Tìm hiểu thêm</a>
										</div>
								</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h5>Chúng tôi biết bạn thích điều gì</h5>
				...
				<ul class="cbp-ig-grid">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">Quán Cafe</h4>
							<span class="cbp-ig-category">SUN RISE</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Giới thiệu về SUN RISE của chúng tôi</h3> 
		   ...
		   <div class="advantage-bottom">
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					...
					<p><i class="fa fa-check" aria-hidden="true"></i>Dịch vụ hướng dẫn 24h</p>
			 	</div>
			 </div>
			<div class="clearfix"> </div>
			</div>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>6.000.000</span> vnđ</h3>						
								<a href="admin/reservation.php" >Đặt bây giờ</a>
							</div>
						</div>
					</div>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Điện thoại :</strong>0912894015</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">levinh0409201@gmail.com</a></p>
			<p class="contact-agile1"><strong>Địa chỉ :</strong>TP.Vinh, Nghệ An</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 SUNRISE . Bảo lưu mọi quyền | Thiết kế bởi <a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
